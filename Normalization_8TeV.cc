...
void Normalization_8TeV::Init8TeV(){
  ...
  XSectionMap_zh[400.0]=0.00000000001;
  ...
  XSectionMap_tth[400.0]=0.0000000001;
...
void Normalization_8TeV::FillSignalTypes(){
  ...
  SignalTypeMap[-25]=std::make_pair<TString,double>("ggh",400); //120
  SignalTypeMap[-26]=std::make_pair<TString,double>("vbf",400);
  SignalTypeMap[-28]=std::make_pair<TString,double>("wzh",400);
  SignalTypeMap[-27]=std::make_pair<TString,double>("tth",400);

  SignalTypeMap[-21]=std::make_pair<TString,double>("ggh",300); //115
  SignalTypeMap[-22]=std::make_pair<TString,double>("vbf",300);
  SignalTypeMap[-24]=std::make_pair<TString,double>("wzh",300);
  SignalTypeMap[-23]=std::make_pair<TString,double>("tth",300);

  SignalTypeMap[-17]=std::make_pair<TString,double>("ggh",250); //110
  SignalTypeMap[-18]=std::make_pair<TString,double>("vbf",250);
  SignalTypeMap[-20]=std::make_pair<TString,double>("wzh",250);
  SignalTypeMap[-19]=std::make_pair<TString,double>("tth",250);

  SignalTypeMap[-13]=std::make_pair<TString,double>("ggh",200); //105
  SignalTypeMap[-14]=std::make_pair<TString,double>("vbf",200);
  SignalTypeMap[-16]=std::make_pair<TString,double>("wzh",200);
  SignalTypeMap[-15]=std::make_pair<TString,double>("tth",200);
